...
| 이름 | GitHub | 역할 |
| --- | --- | --- |
| 배지민 | [@jiminbae](https://github.com/jiminbae) | 팀장, n8n 워크플로우 아키텍처 설계 및 자동화 파이프라인 구현 |
| 배지훈 | [@BaeCHACHA](https://github.com/BaeCHACHA) | Supabase 기반 DB 스키마 설계, 데이터 모델링 및 백엔드 데이터 연동 |
| 남규리 | [@whyyhyh](https://github.com/whyyhyh) | 조교/학생 워크플로우와 인터랙티브 채점 화면 프론트엔드 구현 |
| 정세진 | [@jinsejeong](https://github.com/jinsejeong) | 프론트엔드 구현, UI/UX 디자인 및 비주얼 요소 정리 |

...
export function SuspicionDialog({ open, onClose, onProceed }) {
  if (!open) return null;
  return (
...
export function SimilarityDialog({ open, onClose }) {
  if (!open) return null;
  return (
    <div className="scrim" onClick={onClose}>
...
export function MaterialPreview({ open, onClose, resource }) {
...
export function AppealDialog({ open, onClose, onSubmit }) {
...
export const Dialogs = { SuspicionDialog, SimilarityDialog, MaterialPreview, AppealDialog, Toast };

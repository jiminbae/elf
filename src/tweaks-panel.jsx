...
export function TweaksPanel({ title = 'Tweaks', noDeckControls = false, children }) {
  ...
  const [hasDeckStage, setHasDeckStage] = React.useState(false);
  const [railEnabled, setRailEnabled] = React.useState(false);
  
  React.useEffect(() => {
    if (typeof document !== 'undefined') {
      setHasDeckStage(!!document.querySelector('deck-stage'));
      setRailEnabled(!!document.querySelector('deck-stage')?._railEnabled);
    }
  }, []);

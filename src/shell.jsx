...
// ============================================================
export function GlobalRail({ active = "courses", role = "ta", onSwitch }) {
  const items = [
...
// ============================================================
export function CourseRail({ active = "assign", role = "ta", onSelect }) {
  const taItems = [
    { key: "home",    label: "홈" },
    { key: "notice",  label: "공지" },
...
// ============================================================
export function SimpleTopBar({ search = false }) {
  return (
...
export const Shell = { GlobalRail, CourseRail, GradingTopBar, SimpleTopBar, Crumbs };

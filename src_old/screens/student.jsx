/* global React, Icon, Shell, MOCK */

// ============================================================
// Student dashboard — assignment list
// ============================================================
function StudentDashboard({ onOpen }) {
  ...
  return (
    <>
      ...
      {/* Growth panel */}
      <div className="card mt-20" style={{ padding: "20px 22px" }}>
...
// ============================================================
// Student feedback view — graded result
// ============================================================
function StudentFeedback({ assignment, onAppeal, onOpenResource }) {
  const a = assignment;
  ...
  return (
    <>
      ...
      {isGraded ? (
        ...
        <div className="s-hero pending mt-16">
...
function TAFeedback({ a }) {
  return (
    <div className="feedback-card mt-16">
  ...
  return (
    <div className="s-plan">
      ...
      <div className="resources">
        <a className="res" onClick={() => onOpenResource({ kind: "slide", title: "강의 3주차 슬라이드 — 예외 처리 (12~18p)" })}>
        ...
        <a className="res" onClick={() => onOpenResource({ kind: "external", title: "Python 공식 문서: List time complexity" })}>
          <span className="ico"><Icon.ext width="16" height="16" /></span>
          <span>Python 공식 문서: List time complexity</span>
          <span className="arrow"><Icon.arrowR width="14" height="14" /></span>
        </a>
        <a className="res" onClick={() => onOpenResource({ kind: "video", title: "강의 영상 — try/except 구문 (8분)" })}>
...
window.StudentFeedback = StudentFeedback;
